...
jfieldID wallet_v3_accountState::public_key_fieldID;
...
wallet_v3_accountState::wallet_v3_accountState(std::int64_t wallet_id_, std::int32_t seqno_, std::string const &public_key_)
