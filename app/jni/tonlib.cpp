/*
    ...
    Copyright 2017-2021 trm-dev team
*/
#include <jni.h>
#include <string>
#include <cstdint>
...
/*extern "C" JNIEXPORT jstring JNICALL Java_drinkless_org_ton_MainActivity_stringFromJNI(JNIEnv *env,
                                                                                          jobject *//* this *//*,
                                                                                          jstring dir) {
...
/*extern "C" JNIEXPORT jlong JNICALL Java_drinkless_org_ton_ClientJsonNative_create(JNIEnv *env, jobject *//* this *//*) {
  return reinterpret_cast<jlong>(tonlib_client_json_create());
}
extern "C" JNIEXPORT void JNICALL Java_drinkless_org_ton_ClientJsonNative_send(JNIEnv *env, jobject *//* this *//*,
...
extern "C" JNIEXPORT jstring JNICALL Java_drinkless_org_ton_ClientJsonNative_execute(JNIEnv *env, jobject *//* this *//*,
                                                                                        jstring j_query) {
  auto query = td::jni::from_jstring(env, j_query);
  return td::jni::to_jstring(env, tonlib_client_json_execute(nullptr, query.c_str()));
}
extern "C" JNIEXPORT jstring JNICALL Java_drinkless_org_ton_ClientJsonNative_receive(JNIEnv *env, jobject *//* this *//*,
                                                                                        jlong client, jdouble timeout) {
  return td::jni::to_jstring(env, tonlib_client_json_receive(reinterpret_cast<void *>(client), timeout));
}
extern "C" JNIEXPORT void JNICALL Java_drinkless_org_ton_ClientJsonNative_destroy(JNIEnv *env, jobject *//* this *//*,
                                                                                     jlong client) {
