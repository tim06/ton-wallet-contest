...
import com.github.tim06.wallet_contest.crypto.Crc32c;
import com.github.tim06.wallet_contest.ui.feature.tonConnect.SignatureUtilKt;
...
public class Utils {
    ...
    public static String bytesToBase64(byte[] bytes) {
        return SignatureUtilKt.base64(bytes);
    }

    public static byte[] base64ToBytes(String base64) {
        return SignatureUtilKt.base64(base64);
    }

    public static String bytesToBase64SafeUrl(byte[] bytes) {
        return SignatureUtilKt.base64Url(bytes);
    }
