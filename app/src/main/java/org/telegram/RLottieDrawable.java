...
public class RLottieDrawable extends BitmapDrawable implements Animatable {
        ...
        public void run() {
            ...
            if (backgroundBitmap == null) {
                try {
                    ...
                    Log.e("RLottieDrawable", e.getLocalizedMessage());
                }
            }
            if (backgroundBitmap != null) {
    ...
    public RLottieDrawable(InputStream rawRes, String name, int w, int h) {
        this(rawRes, name, w, h, true);
    }

    public RLottieDrawable(InputStream rawResInputStream, String name, int w, int h, boolean startDecode) {
        try {
            InputStream inputStream = rawResInputStream;//ApplicationLoader.applicationContext.getResources().openRawResource(rawRes);
            int readLen;
            int totalRead = 0;
